...
public class GankActivity extends AppCompatActivity
    ...
    public static int navigationItemNumber = 1;

    SectionsPagerAdapter newsSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(), GankActivity.this);
    GankSectionsPagerAdapter gankSectionsPagerAdapter = new GankSectionsPagerAdapter(getSupportFragmentManager(), GankActivity.this);
    TabLayout tabLayout;
    ViewPager viewPager;
...
//        });
        ...
        Log.i("---check-next--", "initView: " + getSupportFragmentManager().getFragments());
    }
